...
import CollectedObjectModel from './';
...
const DoubleConnectedView = connect(CollectedObjectModel, connect_name_2)(connect(CollectedObjectModel, connect_name_1)(BasicView));
